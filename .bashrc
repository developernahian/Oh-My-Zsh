...
##-----------------------------------------------------
## better-ls
if [ -f /root/.config/synth-shell/better-ls.sh ] && [ -n "$( echo $- | grep i )" ]; then
	source /root/.config/synth-shell/better-ls.sh
fi

##-----------------------------------------------------
## alias
if [ -f /root/.config/synth-shell/alias.sh ] && [ -n "$( echo $- | grep i )" ]; then
	source /root/.config/synth-shell/alias.sh
fi

##-----------------------------------------------------
## better-history
if [ -f /root/.config/synth-shell/better-history.sh ] && [ -n "$( echo $- | grep i )" ]; then
	source /root/.config/synth-shell/better-history.sh
fi
